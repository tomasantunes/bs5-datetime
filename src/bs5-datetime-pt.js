  ...
  tpl.innerHTML = `
      <div class="dtp-popup shadow rounded" role="dialog" aria-modal="false">
          <div class="dtp-header d-flex justify-content-between align-items-center p-2 border-bottom">
              ...
              <div class="dtp-nav">
              <button type="button" class="btn btn-sm dtp-prev" aria-label="Mês Anterior">‹</button>
              <button type="button" class="btn btn-sm dtp-next" aria-label="Próximo Mês">›</button>
              </div>
          </div>
          ...
          <div class="dtp-time p-2 border-top d-flex gap-2 align-items-center">
              ...
              <input type="number" class="form-control form-control-sm dtp-hour" min="0" max="23" inputmode="numeric" aria-label="Horas" style="width:4.5rem">
              <span>:</span>
              <input type="number" class="form-control form-control-sm dtp-minute" min="0" max="59" inputmode="numeric" aria-label="Minutos" style="width:4.5rem">
              <div class="ms-auto">
